from libs.bme680_consts import *
import math
import time
...
class BME680(BME680Data):
    ...
    :param int i2c_addr: One of I2C_ADDR_PRIMARY (0x76) or I2C_ADDR_SECONDARY (0x77)
    :param machine.I2C i2c: Compatible instance for facilitating i2c communications

    """
    def __init__(self, i2c_addr = I2C_ADDR_PRIMARY, i2c = None):
    ...
    def set_gas_heater_profile(self, temperature, duration, nb_profile = 0):
        ...
        :param float temperature: Target temperature in degrees celsius, between 200 and 400
        :param int duration: Target duration in milliseconds, between 1 and 4032
        :param int nb_profile: Target profile, between 0 and 9
    ...
    def set_gas_heater_temperature(self, value, nb_profile = 0):
        ...
        :param float value: Target temperature in degrees celsius, between 200 and 400
    ...
    def set_gas_heater_duration(self, value, nb_profile = 0):
        ...
        :param int value: Heating duration in milliseconds
